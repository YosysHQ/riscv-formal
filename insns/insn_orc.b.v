...
`endif
  ...
  // ORC.B instruction
  wire [`RISCV_FORMAL_XLEN-1:0] result = orcb32(rvfi_rs1_rdata);
...
function logic [31:0] orcb32(logic [31:0] x);
  ...
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct7 == 7'b 0010100 && insn_funct5 == 5'b 00111 && insn_funct3 == 3'b 101 && insn_opcode == 7'b 0010011;
