...
`endif
  ...
  // REV8 instruction
  wire [`RISCV_FORMAL_XLEN-1:0] result = rev8_32(rvfi_rs1_rdata);
...
function logic [31:0] rev8_32(logic [31:0] x);
  ...
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct7 == 7'b 0110100 && insn_funct5 == 5'b 11000 && insn_funct3 == 3'b 101 && insn_opcode == 7'b 0010011;
