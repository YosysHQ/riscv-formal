...
`endif
  ...
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct6 == 6'b 011010 && insn_funct3 == 3'b 001 && insn_opcode == 7'b 0010011 && (!insn_shamt[5] || `RISCV_FORMAL_XLEN == 64);
