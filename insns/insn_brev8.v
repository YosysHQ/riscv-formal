...
`endif
  ...
  // I-type instruction format (bytewise variation)
  wire [`RISCV_FORMAL_ILEN-1:0] insn_padding = rvfi_insn >> 16 >> 16;
  wire [11:0] insn_funct12 = rvfi_insn[31:20];
...
`endif
  ...
  begin
    ...
    begin
      for (j=0; j<8; j=j+1)
      begin
        result[i*8+j] = rvfi_rs1_rdata[(i+1)*8-(j+1)];
      end
    end
  end
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct12 == 12'b 011010000111 && insn_funct3 == 3'b 101 && insn_opcode == 7'b 0010011;
