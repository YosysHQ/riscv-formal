...
`endif
  ...
  begin
    ...
    begin
      ...
      result[2*i + 1] = rvfi_rs1_rdata[i + `RISCV_FORMAL_XLEN/2];
    end
  end
  assign spec_valid = rvfi_valid && !insn_padding && `RISCV_FORMAL_XLEN==32 && insn_funct7 == 7'b 0000100 && insn_funct5 == 5'b 01111 && insn_funct3 == 3'b 001 && insn_opcode == 7'b 0010011;
