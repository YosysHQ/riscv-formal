...
`endif
  ...
  begin
    ...
    begin
      result[i*8+:8] = {8{|rvfi_rs1_rdata[i*8+:8]}};
    end
  end
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct12 == 12'b 001010000111 && insn_funct3 == 3'b 101 && insn_opcode == 7'b 0010011;
