...
`endif
  ...
  // ZEXT.H instruction
  wire [`RISCV_FORMAL_XLEN-1:0] result = {16'b 0, rvfi_rs1_rdata[15:0]};
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct7 == 7'b 0000100 && insn_funct3 == 3'b 100 && insn_opcode == 7'b 0110011 && spec_rs2_addr == 5'h0;
