...
`endif
  ...
  // CLZ instruction
  wire [`RISCV_FORMAL_XLEN-1:0] result = clz32(rvfi_rs1_rdata);
  ...
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct7 == 7'b 0110000 && insn_funct5 == 5'b 00000 && insn_funct3 == 3'b 001 && insn_opcode == 7'b 0010011;
