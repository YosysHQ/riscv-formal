...
`endif
  ...
  // SLLI_UW instruction
  wire [`RISCV_FORMAL_XLEN-1:0] result = rvfi_rs1_rdata[31:0] << insn_shamt;
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct6 == 6'b 000010 && insn_funct3 == 3'b 001 && insn_opcode == 7'b 0011011 && 1;
