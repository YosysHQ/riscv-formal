...
`endif
  ...
  // BEXTI instruction
  wire [`RISCV_FORMAL_XLEN-1:0] index = shamt & (`RISCV_FORMAL_XLEN - 1);
  wire [`RISCV_FORMAL_XLEN-1:0] result = (rvfi_rs1_rdata >> index) & 1;
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct6 == 6'b 0100100 && insn_funct3 == 3'b 101 && insn_opcode == 7'b 0010011 && (!insn_shamt[5] || `RISCV_FORMAL_XLEN == 64);
