...
`endif
  ...
  // PACKH instruction
  wire [16-1:0] result = {rvfi_rs2_rdata[(16/2)-1:0], rvfi_rs1_rdata[(16/2)-1:0]};
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct7 == 7'b 0000100 && insn_funct3 == 3'b 111 && insn_opcode == 7'b 0110011;
