...
`endif
  ...
  // SEXT_B instruction
  wire [8-1:0] result = rvfi_rs1_rdata[8-1:0];
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct7 == 7'b 0110000 && insn_funct5 == 5'b 00100 && insn_funct3 == 3'b 001 && insn_opcode == 7'b 0010011;
  assign spec_rs1_addr = insn_rs1;
  assign spec_rd_addr = insn_rd;
  assign spec_rd_wdata = spec_rd_addr ? {{`RISCV_FORMAL_XLEN-8{result[8-1]}}, result} : 0;
